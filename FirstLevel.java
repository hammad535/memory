...
public class FirstLevel implements ActionListener {
    ...
    int level = 4; // Set number of levels to 4
    int score = 0;
    ...
    public void winner() {
        ...
        if (parts.length >= 2) {
            ...
            if (timeParts.length >= 2) {
                ...
                int timeTaken = 30 - secondsRemaining;
                //System.out.println("Time taken: " + timeTaken);
                gameTimer.stop();
                frame.dispose();
                if(moveCount==4)
                { JOptionPane.showMessageDialog(frame, "Are you hacking?!");
                	
                }

                new WinClass(moveCount, timeTaken,"1");
            } else {
    ...
    public void createBoard() {
        ...
        timerLabel = new JLabel("Timer: 00:30");
    ...
    public void actionPerformed(ActionEvent click) {
        ...
        //System.out.println("mathced pairs " +matchedPairs);
