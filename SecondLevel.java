...
public class SecondLevel implements ActionListener {
    ...
    int level = 6; // Set number of levels to 4
    int score = 0;
    ...
    public void winner() {
        ...
        if (parts.length >= 2) {
            ...
            if (timeParts.length >= 2) {
                ...
                int timeTaken = 45 - secondsRemaining;
                //System.out.println("Time taken: " + timeTaken);
                gameTimer.stop();
                frame.dispose();

                new WinClass(moveCount, timeTaken,"2");
            } else {
    ...
    public void createBoard() {
        ...
        timerLabel = new JLabel("Timer: 00:45");
